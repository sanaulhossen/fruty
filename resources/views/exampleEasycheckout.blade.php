...
<head>
    ...
    <title>Fruty - EasyCheckout (Popup) | SSLCommerz</title>
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                ...
                @foreach ($cart_data as $data)
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            ...
                            <small class="text-muted">Quantaty - {{ number_format($data['item_quantity']) }}</small>
                        </div>
                        <span class="text-muted">{{ number_format($data['item_price'], 2) * number_format($data['item_quantity']) }}</span>
                    </li>
                @endforeach
                ...
                <li class="list-group-item d-flex justify-content-between">
                    ...
                    <strong>{{ session('cart_sub_total') }} TK</strong>
                </li>
                <li class="list-group-item d-flex justify-content-between">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <input type="hidden" value="{{ session('total') }}" name="amount" id="total_amount" required/>
